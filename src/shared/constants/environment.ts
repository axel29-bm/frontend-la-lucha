...
export const API_URL = import.meta.env.VITE_API_URL ?? 'http://localhost:5218/api';
...
export const AUTH_LOGIN_URL = import.meta.env.VITE_AUTH_LOGIN_URL ?? `${API_URL}/Auth/login`;
...
// export const TRANSACTIONS_URL = `${AP