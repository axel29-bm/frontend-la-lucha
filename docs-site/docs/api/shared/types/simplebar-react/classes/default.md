...
Defined in: [src/shared/types/simplebar-react.d.ts:9](https://bitbucket.org/devticketeg/multipago-reporte-2025/src/8b856e62a15b8057c67006e5179ef29fbfb5872d/src/shared/types/simplebar-react.d.ts#lines-9)
...
- `Component`\<`React.HTMLAttributes`\<`HTMLDivElement`\>, `object`\>

## Constructors

### Constructor

> **new default**(`props`): `SimpleBar`
...
`React.Component<React.HTMLAttributes<HTMLDivElement>, object>.constructor`

### Constructor

> **new default**(`props`, `context`): `SimpleBar`
...
Defined in: node\_modules/@types/react/index.d.ts:968
...
`null` | `object` | (`prevState`, `props`) => `null` \| `object` \| `Pick`\<`object`, `K`\> | `Pick`\<`object`, `K`\>
